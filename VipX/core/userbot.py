...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("jatinzx")
                await self.one.join_chat("jatinzx")
                await self.one.join_chat("music_supportz")
                await self.one.join_chat("music_supportz")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("jatinzxs")
                await self.two.join_chat("jatinzx")
                await self.two.join_chat("music_supportz")
                await self.two.join_chat("music_supportz")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("jatinzx")
                await self.three.join_chat("jatinzx")
                await self.three.join_chat("music_supportz")
                await self.three.join_chat("music_supportz")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("jatinzx")
                await self.four.join_chat("jatinzx")
                await self.four.join_chat("music_supportz")
                await self.four.join_chat("music_supportz")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("jatinzx")
                await self.five.join_chat("music_supportz")
                await self.five.join_chat("music_supportz")
            except:
                pass
            assistants.append(5)
